...
\Todo{JW: why go through all this if it's really only the
  jet-balancing configs that we eventually are referring to? Plus the
  jet-balancing also occurs for two hard jets}.
This latter region
...
\Minlo predictions. \Todo{JW: do you mean Minlo or NNLOPS? Minlo looks
  like the other NLO preds.}
...
a more or less constant ratio wrt.~\Herwig and \MGaMC. This is
evidence for the effect of a scale choice unable to identify the
Higgs-strahlungs component here. \Todo{JW: have trouble with the last
  sentence, basically what evidences what, it's not clear to me. Do
  you refer to the jet-balancing config?}
