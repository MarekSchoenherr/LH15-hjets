...
term of the Sudakov resummation, also included in \Powheg and \Resbos
in particular, benefits the BFGLP $hj$ NNLO calculation. However, it
can be noticed (see fourth ratio plot in
Figure~\ref{fig:hjetscomp:results:1obs:hpt}) that apart from \Powheg,
\Resbos and the BFGLP $hj$ NNLO calculation, all other approaches
