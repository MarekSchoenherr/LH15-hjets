...
While the $p_\perp(j_1)$ distribution already showed good agreement,
...
resummed in/by \Resbos as long as $p_\perp(hj_1)<p_\perp(j_1)$. In
addition, terms of the form $\ln(1/R^2)$ are also taken into account
and lead to a somewhat broader, upward shifted Sudakov peak.
