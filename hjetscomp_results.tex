...
the very first bin, the \GoSam{}+\Sherpa based calculations show a rather
constant rate increase of about 20\% wrt.~\Powheg pointing to a
$K$-factor size one more or less expects for $h+2$-jet production.
...
The most accurate predictions here come from the NLO computation of \GoSam+\Sherpa
and \Sherpa \MEPSatNLO both of which include the 3rd jet at NLO accuracy and the 4th jet at LO accuracy.
\MGaMC and \Herwig both include the 3rd jet at LO while the 4th jet is LO in \Herwig but showered in \MGaMC.
...
The Higgs boson transverse momentum distribution for $H+\ge3$ jets is shown in
...
more radiation than Pythia8. The \Hej prediction begins to increase over
\Powheg at high $p_T$ and is closer to the NLO results of \GoSam+\Sherpa and
...
di-jet observables, yet for this observable grow with $p_T$.
...
\MEPSatNLO has much smaller scale uncertainty than \MGaMC which . The fixed
...
The $H_T$ distribution for the sum of jet transverse momenta in $H+\ge1$ jets
is shown in Figure~\ref{fig:hjetscomp:results:mobs:HT_jets}. This observable is
extremly sensitive to additional radiation and is a useful case to see the impact
of different jet multiplicities. The NNLO+PS tools of \Sherpa\NNLOPS and \Powheg
deviate significantly for $150 < H_T < 600$. \Sherpa\NNLOPS agrees better with the
NNLO fixed order prediction for $H+1$ jet and to a certain extent the \Sherpa\MEPSatNLO
computation. \Herwig and \MGaMC give results consistent with \Powheg except for deviations
at low energies but with relatively large errors.

For very high $H_T^{\rm jet}$ all tools including some approximation to the 3rd
