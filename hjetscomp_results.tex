...
boson is required, with no restrictions on its momentum. Two important predictions
...
the calculations should agree exactly. For $N=3$, only the \Sherpa \MEPSatNLO
