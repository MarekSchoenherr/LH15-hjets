...
\begin{figure}[t!]
  ...
  \caption{\label{fig:higgscomp:results:inclobs:njets}%
    ...
    ratios wrt.\ the \Powheg \NNLOPS prediction. The upper of these plots
...
parton showers only. Naturely, here the differences between the \NNLOPS 
predictions are largest. Please note, that the resepctive parton showering 
