...
%     rapidity distance of a central jet to the centre of the most forward 
%     and most backward jet.
%     \label{fig:higgscomp:results:jvobs:cjvxsvbf2}
%   }
% \end{figure}
% 
...
% Figure \ref{fig:higgscomp:results:jvobs:cjvxsvbf}. Here, all parton shower based 
...
% Figure \ref{fig:higgscomp:results:jvobs:cjvxsvbf2}. While, of course, the 
