...
matched to the \hjetscompPythia 8 (v.210) parton
...
\hjetscompMGaMC code, which, in the context of FxFx merging, is
...
$m_h$ as the scale. The central merging scale is taken to be $35\,\hjetscompgev$,
while the variations include $25\,\hjetscompgev$ and $50\,\hjetscompgev$. These scales include 
...
when there are notable differences, they can be traced to the larger scale choice of \hjetscompMGaMC. 
