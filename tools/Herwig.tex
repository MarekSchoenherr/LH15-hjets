...
\hjetscompHerwig \ \cite{Bellm:2015jjp} dipole shower module based on
...
publicly available in \hjetscompHerwig. We use \hjetscompMGaMC
...
merging scale of $30\,\hjetscompgev$, NLO accuracy of the first additional
