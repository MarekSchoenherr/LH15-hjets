...
\Todo{did we really use the scale choice in above equation for GoSam+Sherpa? I thought it was $H'_T/2$ as usual?}
...
\Todo{is it $pp\to h+0,1,2\,\text{jets}$ or $pp\to h+1,2\,\text{jets}$ ?}
