...
$m_h=125\,\hjetscompgev$, which is left undecayed. We used the 
...
using the \hjetscompLoopsim \cite{Rubin:2010xp} procedure to make an approximate 
...
$p_T>25$ GeV. The \hjetscompLoopsim procedure uses a flavour sensitive 
