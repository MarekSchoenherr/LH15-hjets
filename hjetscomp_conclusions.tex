...
data sample, precision Higgs boson measurements all now be possible. The 
largest Higgs boson sub-process is $gg$ fusion. A variety of theoretical 
...
approximate NNLO), resummed predictions, NNLO predictions with parton 
showers, and parton shower predictions using matrix element information 
at LO, NLO and NNLO. This allows a better understanding of (1) how 
...
been carried out without non-perturbative corrections to allow for easier 
...
inclusive lead jet $p_\perp$ distribution. 
...
The \MEPSatNLO predictions agree well with NLO/NNLO at low $p_\perp$, 
...
high $p_\perp$ for the Higgs boson must be supplied by a combination of 
